...
public class baclog_reg_by_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentsub=FirebaseDatabase.getInstance().getReference("StudentSubDeatails");
        ...
        studentenrolledsub.child(itemfacsublist).child(sid).setValue(batchdetailss).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    String subcodebatch;
                    subcodebatch=(itemfacsublist);
                    AddSubByAdmin addsub=new AddSubByAdmin(subcodebatch);
                    //studentsub.setValue(sid);
                    DatabaseReference studea=FirebaseDatabase.getInstance().getReference("StudentSubDeatails").child(sid).child(subcodebatch);
                    studea.setValue(addsub);
